...
require.register("vue-router/dist/vue-router.js", function(exports, require, module) {
...
require.register("vue/dist/vue.common.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {"transform":["envify"]}, "vue");
  (function() {
    /*!
 * Vue.js v1.0.25
 * (c) 2016 Evan You
...
require.register("js/app/mixins/jobs.coffee", function(exports, require, module) {
module.exports = {
  methods: {
    ...
    setWorkers: function(queue_name, params, callback) {
      if (params == null) {
        params = {};
      }
      return this.$http['post']("/bolt/api/" + queue_name + "/workers", params).then(function(resp) {
        return callback(resp.data);
      })["catch"](function(resp) {
        return console.log(resp);
      });
...
module.exports = {
  ...
  methods: {
    updateStatus: function() {
      return this.getStatus({}, (function(_this) {
    ...
    addWorker: function(queue) {
      return this.setWorkers(queue.queue_name, {
        worker_max: queue.worker_max + 1
      }, (function(_this) {
        return function(data) {
